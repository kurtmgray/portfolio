...
export const aboutMe = "A skilled software developer focused on solving problems with clean, maintainable code with development driven by SOLID principles. My passion for building mechanisms for addressing real-world problems extends from my considerable experience as a teacher, curriculum developer, composer, visual designer, and team leader in the education space. As a software developer I have taken those skills into web app and backend development integrating powerful and relevant technologies in the Javascript and Java ecosystems. I am a graduate of the FastTrack Full-Stack Developer program, The Odin Project development curriculum, with bachelor’s and masters degrees from leading universities."
